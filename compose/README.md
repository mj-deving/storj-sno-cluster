...
> **Status:** Starts cleanly on a fresh host. Requires your own Storj
> node identity and authorization token. Not operated by us. The
> storagenode image digest is pinned at template-publication time; the
> container's built-in auto-updater is allowed to roll the binary
> forward in line with Storj's protocol releases (see
